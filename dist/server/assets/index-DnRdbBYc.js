...
function PakistanSection() {
  ...
  return /* @__PURE__ */ jsx("section", { className: "bg-off-white py-24", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-14 items-start", children: [
    /* @__PURE__ */ jsxs(Reveal, { children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-7", children: /* @__PURE__ */ jsxs("a", { href: "https://abdullahqadeer.com/tax-calculators/freelancer-tax-calculator", target: "_blank", rel: "noopener noreferrer", className: "btn-gold inline-flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxs(Reveal, { delay: 150, className: "space-y-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "bg-white border border-border rounded-2xl p-6", children: [
        /* @__PURE__ */ jsx("div", { className: "font-serif text-5xl text-gold-500 leading-none", children: "0.25%" }),
        /* @__PURE__ */ jsx("p", { className: "mt-3 text-dark-text font-semibold", children: "Reduced IT Export Tax Rate" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-500 text-[13px] mt-1", children: "Under Sec 154A with PSEB Registration & FBR ATL Status" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-white border border-border rounded-2xl p-6", children: [
        /* @__PURE__ */ jsx("div", { className: "font-serif text-4xl font-bold text-gold-500 leading-none", children: "0.25% vs 35%" }),
        /* @__PURE__ */ jsx("p", { className: "mt-3 text-dark-text font-semibold", children: "Concessionary vs Standard Tax Rate" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-500 text-[13px] mt-1", children: "Save significant tax legally by maintaining your PSEB & FBR compliance" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-navy-900 rounded-2xl p-6", children: [
        /* @__PURE__ */ jsx(Scale, { size: 28, className: "text-gold-500" }),
        /* @__PURE__ */ jsx("p", { className: "mt-3 text-white font-semibold", children: "Punjab Bar Council Licensed Advocate" }),
        /* @__PURE__ */ jsx("p", { className: "text-navy-200 text-[13px] mt-1", children: "Your legal and tax matters handled directly by a qualified advocate — not just an unverified agent." })
      ] })
    ] })
  ] }) });
}
