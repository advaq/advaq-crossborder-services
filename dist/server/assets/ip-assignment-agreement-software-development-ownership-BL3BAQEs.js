...
import { a7 as faqs } from "./router-B1vRwgby.js";
  ...
  return /* @__PURE__ */ jsxs("article", { className: "min-h-screen bg-white", children: [
    /* @__PURE__ */ jsxs("section", { className: "bg-navy-950 pt-36 pb-20 text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-4xl mx-auto px-6", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "font-serif text-[34px] sm:text-[44px] md:text-[52px] leading-[1.15] text-white font-medium", children: "Who Owns the Code? Intellectual Property Rights Transfer in Software Development" }),
        /* @__PURE__ */ jsx("p", { className: "mt-6 text-navy-200 text-base sm:text-lg leading-relaxed max-w-3xl", children: "A comprehensive IP law tutorial for software engineering agencies, SaaS startups, and client founders on copyright ownership, IP assignment timing, and background framework licensing." }),
        /* @__PURE__ */ jsxs("div", { className: "mt-8 pt-8 border-t border-white/10 flex flex-wrap items-center justify-between gap-6 text-xs text-navy-200", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(User, { size: 14, className: "text-gold-500" }),
              /* @__PURE__ */ jsx("span", { children: "ADVAQ IP Legal Team" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "max-w-4xl mx-auto px-6 -mt-8 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "bg-navy-900 border border-gold-500/30 rounded-2xl p-6 md:p-8 shadow-xl text-white", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-gold-500 font-semibold text-sm uppercase tracking-wider mb-3", children: [
        ...
        /* @__PURE__ */ jsx("span", { children: "Software IP Core Principles" })
      ] }),
      /* @__PURE__ */ jsxs("ul", { className: "space-y-2.5 text-sm sm:text-[15px] text-navy-100 leading-relaxed", children: [
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Default Ownership:" }),
            " Creators (contractors) own software copyright by default unless assigned in writing."
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Payment Condition:" }),
            " IP assignment must be strictly conditioned upon full receipt of project fees."
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Background IP Carve-Out:" }),
            " Agency retains ownership of internal toolkits, boilerplate code, and frameworks."
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Non-Exclusive License:" }),
            " Client receives perpetual non-exclusive license to use agency background code embedded in final software."
          ] })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("section", { className: "max-w-4xl mx-auto px-6 py-16 text-gray-800 leading-relaxed text-[16px]", children: [
      ...
      /* @__PURE__ */ jsxs("div", { id: "default-copyright-rules", className: "space-y-4 mb-12", children: [
        ...
        /* @__PURE__ */ jsx("p", { children: "Many clients mistakenly assume that paying an agency for software development automatically transfers code copyright. Under international copyright law, the author retains copyright until an explicit written assignment is executed." })
      ] }),
      /* @__PURE__ */ jsxs("div", { id: "work-made-for-hire", className: "space-y-4 mb-12", children: [
        ...
        /* @__PURE__ */ jsx("p", { children: 'Work-Made-For-Hire doctrines apply to W-2 employees. For third-party B2B agencies and contractors, contracts must include an explicit Present Assignment clause ("Developer hereby assigns...").' })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "my-10 bg-navy-950 p-8 rounded-2xl text-white relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-gold-500 uppercase text-xs font-semibold tracking-widest", children: "IP ASSIGNMENT CONTRACT SERVICES" }),
      ...
      /* @__PURE__ */ jsxs("div", { id: "payment-conditioned-assignment", className: "space-y-4 mb-12", children: [
        ...
        /* @__PURE__ */ jsx("p", { children: `Structure IP transfer clauses to state that ownership transfers to the client "contingent upon, and subject to, Client's payment in full of all fees owed."` })
      ] }),
      /* @__PURE__ */ jsxs("div", { id: "background-ip-carveout", className: "space-y-4 mb-12", children: [
        ...
        /* @__PURE__ */ jsx("p", { children: "Explicitly carve out agency pre-existing frameworks, utilities, and open source components from the assignment, granting clients a perpetual non-exclusive license instead." })
      ] }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "bg-navy-950 py-20 text-center text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-4xl mx-auto px-6", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "font-serif text-3xl md:text-5xl mt-3 text-white", children: "Secure Your Software IP Rights" }),
        /* @__PURE__ */ jsx("p", { className: "mt-4 text-navy-200 text-base max-w-xl mx-auto", children: "IP Assignment Agreement drafting, background code carve-outs, conditional transfer provisions, and open-source compliance." }),
