...
import { K as faqs } from "./router-B1vRwgby.js";
  ...
  return /* @__PURE__ */ jsxs("article", { className: "min-h-screen bg-white", children: [
    /* @__PURE__ */ jsxs("section", { className: "bg-navy-950 pt-36 pb-20 text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-4xl mx-auto px-6", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-6 text-navy-200 text-base sm:text-lg leading-relaxed max-w-3xl", children: "A comprehensive foreign exchange compliance guide for Pakistani IT exporters and agency owners on State Bank of Pakistan (SBP) Form R processing, purpose code selection, and Proceed Realization Certificate (PRC) management." }),
      ...
      /* @__PURE__ */ jsxs("ul", { className: "space-y-2.5 text-sm sm:text-[15px] text-navy-100 leading-relaxed", children: [
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Form R Classification:" }),
            " Mandatory bank declaration form for incoming foreign wire transfers."
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Key SBP Purpose Codes:" }),
            " 9186 (Software Consultancy), 9187 (Software Export), 9188 (IT Services)."
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "e-PRC Issuance:" }),
            " Electronic Proceed Realization Certificate required for 0.25% FBR tax return claims."
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Payoneer / Wise Wire Realization:" }),
            " Ensure receiving bank tags third-party merchant payouts under IT export codes."
          ] })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("section", { className: "max-w-4xl mx-auto px-6 py-16 text-gray-800 leading-relaxed text-[16px]", children: [
      /* @__PURE__ */ jsxs("div", { className: "bg-off-white border border-border p-6 rounded-xl mb-12", children: [
        ...
        /* @__PURE__ */ jsxs("ol", { className: "space-y-2 text-sm text-navy-900 list-decimal list-inside font-medium", children: [
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "#what-is-form-r", className: "hover:text-gold-600 underline", children: "1. What Is SBP Form R and Why Does It Matter?" }) }),
          ...
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "#eprc-issuance", className: "hover:text-gold-600 underline", children: "3. How to Obtain Electronic Proceed Realization Certificates (e-PRC)" }) }),
      ...
      /* @__PURE__ */ jsxs("div", { id: "what-is-form-r", className: "space-y-4 mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "font-serif text-2xl md:text-3xl text-dark-text font-semibold", children: "1. What Is SBP Form R and Why Does It Matter?" }),
        /* @__PURE__ */ jsxs("p", { children: [
          "Whenever a foreign client transfers foreign currency (USD, EUR, GBP) to your company bank account in Pakistan, the receiving bank processes an electronic ",
          /* @__PURE__ */ jsx("strong", { children: "Form R (Remittance Form)" }),
          " reported directly to the State Bank of Pakistan."
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { id: "sbp-purpose-codes", className: "space-y-4 mb-12", children: [
        ...
        /* @__PURE__ */ jsx("p", { children: "To qualify for the 0.25% Section 154A reduced tax rate, your incoming wire transfer must be tagged under correct SBP Purpose Codes:" }),
        /* @__PURE__ */ jsxs("ul", { className: "list-disc list-inside space-y-1.5 text-sm text-gray-700 ml-2", children: [
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "9186:" }),
            " Computer Software Consultancy & Implementation Services"
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "9187:" }),
            " Export of Computer Software (Custom Development & SaaS)"
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "9188:" }),
      ...
      /* @__PURE__ */ jsxs("div", { id: "eprc-issuance", className: "space-y-4 mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "font-serif text-2xl md:text-3xl text-dark-text font-semibold", children: "3. How to Obtain Electronic Proceed Realization Certificates (e-PRC)" }),
        /* @__PURE__ */ jsx("p", { children: "An e-PRC is an official digital certificate generated by your bank confirming foreign exchange realization. It serves as primary evidence during FBR income tax audits." })
      ] }),
      /* @__PURE__ */ jsxs("div", { id: "third-party-payouts", className: "space-y-4 mb-12", children: [
        ...
        /* @__PURE__ */ jsx("p", { children: "When withdrawing funds from Payoneer or Wise into local bank accounts, instruct your bank’s foreign exchange officer to issue e-PRCs tagged under IT export purpose codes rather than generic personal remittances." })
      ] }),
