...
import { b as faqs } from "./router-DZ5LLfdT.js";
  ...
  return /* @__PURE__ */ jsxs("article", { className: "min-h-screen bg-white", children: [
    /* @__PURE__ */ jsxs("section", { className: "bg-navy-950 pt-36 pb-20 text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-4xl mx-auto px-6", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-6 text-navy-200 text-base sm:text-lg leading-relaxed max-w-3xl", children: "A comprehensive withholding tax compliance guide for corporate finance leads and business owners on FBR WHT rates under Section 153, foreign payments under Section 152, quarterly Form 165 statements, and CPR deposit receipts." }),
        /* @__PURE__ */ jsxs("div", { className: "mt-8 pt-8 border-t border-white/10 flex flex-wrap items-center justify-between gap-6 text-xs text-navy-200", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(User, { size: 14, className: "text-gold-500" }),
              /* @__PURE__ */ jsx("span", { children: "ADVAQ Corporate Tax Team" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("span", { children: "Income Tax Ordinance Ordinance 2001 Section 153/152" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx("section", { className: "max-w-4xl mx-auto px-6 -mt-8 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "bg-navy-900 border border-gold-500/30 rounded-2xl p-6 md:p-8 shadow-xl text-white", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-gold-500 font-semibold text-sm uppercase tracking-wider mb-3", children: [
        ...
        /* @__PURE__ */ jsx("span", { children: "WHT Corporate Mandate" })
      ] }),
      /* @__PURE__ */ jsxs("ul", { className: "space-y-2.5 text-sm sm:text-[15px] text-navy-100 leading-relaxed", children: [
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Withholding Agent Status:" }),
            " Every SECP Private Limited company is legally designated as a Withholding Agent."
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Section 153 (Local Payments):" }),
            " Deduct WHT on vendor payments for goods, services, and contracts (rates differ for Filers vs Non-Filers)."
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Section 152 (Foreign Payments):" }),
            " Deduct WHT on offshore software licenses and foreign consultant fees."
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Quarterly Form 165 Filings:" }),
            " Submit withholding tax statements on FBR Iris every 3 months."
          ] })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("section", { className: "max-w-4xl mx-auto px-6 py-16 text-gray-800 leading-relaxed text-[16px]", children: [
      /* @__PURE__ */ jsxs("div", { className: "bg-off-white border border-border p-6 rounded-xl mb-12", children: [
        ...
        /* @__PURE__ */ jsxs("ol", { className: "space-y-2 text-sm text-navy-900 list-decimal list-inside font-medium", children: [
          ...
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "#section-152-foreign", className: "hover:text-gold-600 underline", children: "3. Section 152 WHT on Payments to Foreign Companies" }) }),
          ...
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "#disallowance-penalties", className: "hover:text-gold-600 underline", children: "5. Avoiding Expense Disallowance under Section 21(c)" }) }),
      ...
      /* @__PURE__ */ jsxs("div", { id: "withholding-agent-role", className: "space-y-4 mb-12", children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          "Under Section 153 of the Income Tax Ordinance 2001, all SECP registered companies automatically act as ",
          /* @__PURE__ */ jsx("strong", { children: "Withholding Tax Agents" }),
          " for the Federal Board of Revenue."
        ] }),
        /* @__PURE__ */ jsx("p", { children: "When making payments to suppliers, contractors, landlords, or employees, companies must deduct the statutory tax percentage and deposit it into the Federal Treasury via Computerized Payment Receipt (CPR) within 7 days." })
      ] }),
      /* @__PURE__ */ jsxs("div", { id: "section-153-rates", className: "space-y-4 mb-12", children: [
        ...
        /* @__PURE__ */ jsx("p", { children: "Standard Section 153 WHT rates for active tax filers include:" }),
        /* @__PURE__ */ jsxs("ul", { className: "list-disc list-inside space-y-1.5 text-sm text-gray-700 ml-2", children: [
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Supply of Goods:" }),
            " 4% to 5%"
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Services (General):" }),
            " 8% to 11%"
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Specified IT / Software Services:" }),
            " 3% (reduced rate for certified IT services)"
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Execution of Contracts:" }),
            " 7% to 8%"
          ] })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxs("div", { id: "section-152-foreign", className: "space-y-4 mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "font-serif text-2xl md:text-3xl text-dark-text font-semibold", children: "3. Section 152 WHT on Payments to Foreign Companies" }),
        /* @__PURE__ */ jsx("p", { children: "When a Pakistani company pays foreign offshore vendors for cloud software, international consulting, or digital services under Section 152, WHT must be withheld unless an official SBP or FBR Double Tax Treaty Exemption Certificate is held." })
      ] }),
      /* @__PURE__ */ jsxs("div", { id: "quarterly-form-165", className: "space-y-4 mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "font-serif text-2xl md:text-3xl text-dark-text font-semibold", children: "4. Submitting Quarterly Withholding Tax Statements (Form 165)" }),
        /* @__PURE__ */ jsx("p", { children: "Under Section 165, companies file electronic withholding tax statements on FBR Iris 2.0 every quarter (Q1: Oct 20, Q2: Jan 20, Q3: Apr 20, Q4: Jul 20)." })
      ] }),
      /* @__PURE__ */ jsxs("div", { id: "disallowance-penalties", className: "space-y-4 mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "font-serif text-2xl md:text-3xl text-dark-text font-semibold", children: "5. Avoiding Expense Disallowance under Section 21(c)" }),
        /* @__PURE__ */ jsx("p", { children: "Failing to deduct or deposit WHT on vendor invoices causes FBR to disallow the entire underlying expense under Section 21(c), artificially increasing your corporate taxable income." })
      ] }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "bg-navy-950 py-20 text-center text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-4xl mx-auto px-6", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-4 text-navy-200 text-base max-w-xl mx-auto", children: "Section 153 & 152 WHT calculation, CPR payment generation, quarterly Form 165 Iris filings, and Section 161 audit defense." }),
