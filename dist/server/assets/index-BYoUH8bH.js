  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative min-h-[85vh] bg-navy-950 overflow-hidden flex items-center pt-32 lg:pt-36 pb-14", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 lg:gap-8 items-center w-full", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-7 space-y-6 pt-2", children: [
        ...
        /* @__PURE__ */ jsx(Reveal, { delay: 200, children: /* @__PURE__ */ jsx("p", { className: "text-navy-200 text-base md:text-lg max-w-xl leading-[1.7]", children: "Company formation, tax compliance, and legal contracts — managed directly by a licensed advocate & IRS PTIN tax preparer. 100% remote. Full legal accountability." }) }),
