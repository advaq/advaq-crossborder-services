...
import { User, Clock, Shield, CheckCircle2, ArrowRight, Award, ChevronDown } from "lucide-react";
import "sonner";
  ...
  return /* @__PURE__ */ jsxs("article", { className: "min-h-screen bg-white", children: [
    /* @__PURE__ */ jsxs("section", { className: "bg-navy-950 pt-36 pb-20 text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-4xl mx-auto px-6", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-6 text-navy-200 text-base sm:text-lg leading-relaxed max-w-3xl", children: "A comprehensive federal trademark guide for foreign non-resident founders on USPTO clearance searches, US licensed attorney representation requirements, TEAS application fees, and Amazon Brand Registry enrollment." }),
      ...
      /* @__PURE__ */ jsxs("ul", { className: "space-y-2.5 text-sm sm:text-[15px] text-navy-100 leading-relaxed", children: [
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "US Attorney Mandate:" }),
            " The USPTO legally requires all foreign-domiciled applicants to be represented by a licensed US attorney in good standing."
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            ...
            " A USPTO pending or registered trademark unlocks Amazon Brand Registry US, protecting product listings from counterfeit hijackers."
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "$350 TEAS Fee:" }),
            " The official USPTO application fee is $350 per class of goods/services."
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "max-w-4xl mx-auto px-6 py-16 text-gray-800 leading-relaxed text-[16px]", children: [
      /* @__PURE__ */ jsxs("div", { className: "bg-off-white border border-border p-6 rounded-xl mb-12", children: [
        ...
        /* @__PURE__ */ jsxs("ol", { className: "space-y-2 text-sm text-navy-900 list-decimal list-inside font-medium", children: [
          ...
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "#section-1a-vs-1b", className: "hover:text-gold-600 underline", children: "3. Section 1(a) Actual Use vs Section 1(b) Intent-to-Use" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "#application-timeline", className: "hover:text-gold-600 underline", children: "4. Step-by-Step Application Steps & 8-12 Month Timeline" }) }),
      ...
      /* @__PURE__ */ jsxs("div", { id: "uspto-foreign-rule", className: "space-y-4 mb-12", children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          "Effective August 2019, the ",
          /* @__PURE__ */ jsx("strong", { children: "United States Patent and Trademark Office (USPTO)" }),
          " enacted a federal rule requiring all foreign-domiciled applicants (individual or corporate) to be represented by an attorney who is an active member of the bar of a US state."
        ] }),
        /* @__PURE__ */ jsx("p", { children: "Submitting a foreign USPTO application without an authorized US attorney results in immediate office action refusal." })
      ] }),
      /* @__PURE__ */ jsxs("div", { id: "amazon-brand-registry", className: "space-y-4 mb-12", children: [
        ...
        /* @__PURE__ */ jsx("p", { children: "For e-commerce founders selling on Amazon US, a USPTO trademark is essential." }),
        /* @__PURE__ */ jsxs("p", { children: [
          "Once your USPTO serial number is issued, you can immediately apply for ",
          /* @__PURE__ */ jsx("strong", { children: "Amazon Brand Registry" }),
          ", gaining automated protection against counterfeit buy-box hijackers, access to A+ Content, and Amazon Storefront features."
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxs("div", { id: "section-1a-vs-1b", className: "space-y-4 mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "font-serif text-2xl md:text-3xl text-dark-text font-semibold", children: "3. Section 1(a) Actual Use vs Section 1(b) Intent-to-Use" }),
        /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-6 my-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "border border-border p-5 rounded-xl bg-white shadow-sm", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-gold-500 font-semibold text-base mb-2", children: [
              ...
              /* @__PURE__ */ jsx("span", { children: "Section 1(a) Use in Commerce" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600", children: "Filed if you are already selling products or services in US interstate commerce. Requires submitting proof of use (product specimen)." })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "border border-border p-5 rounded-xl bg-white shadow-sm", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-navy-700 font-semibold text-base mb-2", children: [
              ...
              /* @__PURE__ */ jsx("span", { children: "Section 1(b) Intent to Use" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600", children: "Filed before commercial product launch to reserve your brand name priority with USPTO. Specimen is submitted later." })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { id: "application-timeline", className: "space-y-4 mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "font-serif text-2xl md:text-3xl text-dark-text font-semibold", children: "4. Step-by-Step Application Steps & 8-12 Month Timeline" }),
        /* @__PURE__ */ jsxs("ol", { className: "list-decimal list-inside space-y-2 text-sm text-gray-700 ml-2", children: [
          /* @__PURE__ */ jsx("li", { children: "Conduct a thorough USPTO TESS search for confusingly similar marks." }),
          /* @__PURE__ */ jsx("li", { children: "Select international NICE classes (e.g. Class 9 for software, Class 35 for retail)." }),
          /* @__PURE__ */ jsx("li", { children: "Submit TEAS Standard application with $350 fee per class via US licensed counsel." }),
          /* @__PURE__ */ jsx("li", { children: "Pass examining attorney review (approx 8 months)." }),
          /* @__PURE__ */ jsx("li", { children: "Undergo 30-day public publication in the Official Gazette before certificate issuance." })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "bg-navy-950 py-20 text-center text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-4xl mx-auto px-6", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-4 text-navy-200 text-base max-w-xl mx-auto", children: "USPTO clearance searches, US licensed attorney representation, TEAS application filing, and Amazon Brand Registry activation." }),
