  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white text-navy-950", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "bg-navy-950 pt-36 pb-20 text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-5xl mx-auto px-6 text-center", children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "mt-5 text-navy-200 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed space-y-1", children: [
          /* @__PURE__ */ jsx("span", { className: "block", children: "15 free interactive tax, compliance, and financial estimators for UK Limited Company directors, property investors, freelancers, and non-resident founders." }),
          /* @__PURE__ */ jsx("span", { className: "block text-gold-400/90 text-xs sm:text-sm font-medium pt-1", children: "Updated for HMRC 2025/2026 tax bands, DTT relief rules, and Companies House annual filing requirements." })
        ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-slate-50 border-t border-border py-16", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 mt-2 max-w-xl mx-auto", children: "Quick authoritative guidance on UK tax thresholds, Corporation Tax rates, VAT limits, non-resident LTD rules, and property NRLS tax." })
      ] }),
