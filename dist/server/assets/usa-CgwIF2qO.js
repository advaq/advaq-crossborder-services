...
function USACalculatorsHubPage() {
  ...
  const keyRates = [{
    label: "Foreign LLC Income Tax",
    value: "0%",
    detail: "If Non-ETBUS & Non-US Source"
  }, {
    label: "Form 5472 Late Penalty",
    value: "$25,000",
    detail: "Automatic IRS Statutory Fine"
  }, {
    label: "FinCEN BOI Penalty",
    value: "$590/Day",
    detail: "Corporate Transparency Act"
  }, {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white text-navy-950", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "bg-navy-950 pt-36 pb-20 text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-5xl mx-auto px-6 text-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 text-xs uppercase tracking-widest text-gold-400 font-semibold mb-4", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-gray-300", children: "USA Calculators" })
        ] }),
        /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-gold-500/10 text-gold-400 border border-gold-500/20 mb-6", children: [
          ...
          " IRS & FinCEN 2026 Compliance Rules Updated"
        ] }),
        /* @__PURE__ */ jsx("h1", { className: "font-serif text-3xl sm:text-4xl md:text-5xl text-white font-medium max-w-4xl mx-auto leading-tight", children: "🇺🇸 USA Business & Tax Calculators Suite (2026)" }),
        /* @__PURE__ */ jsxs("p", { className: "mt-5 text-navy-200 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed space-y-1", children: [
          /* @__PURE__ */ jsx("span", { className: "block", children: "15 free interactive tax, compliance, and financial estimators for foreign-owned US LLCs, non-resident founders, Amazon sellers, and freelancers." }),
          /* @__PURE__ */ jsx("span", { className: "block text-gold-400/90 text-xs sm:text-sm font-medium pt-1", children: "Updated for IRS 2026 tax regulations, Form 1040-NR ECI brackets, state annual compliance costs, and Mercury bank account approvals." })
        ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-slate-50 border-t border-border py-16", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "font-serif text-2xl sm:text-3xl font-bold text-navy-950 mt-2", children: "Frequently Asked Questions (US Business & Tax)" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 mt-2 max-w-xl mx-auto", children: "Quick authoritative guidance on foreign owner 0% tax rules, IRS Form 5472 $25,000 penalties, FinCEN BOI deadlines, and state selection." })
      ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-navy-950 text-white py-16 border-t border-navy-900", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-6 text-center space-y-6", children: [
      /* @__PURE__ */ jsx("h2", { className: "font-serif text-2xl sm:text-3xl font-bold", children: "Need Personal Guidance from a US Corporate Tax & IRS Compliance Specialist?" }),
      /* @__PURE__ */ jsx("p", { className: "text-navy-200 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed", children: "Get your foreign-owned US LLC formation, SSN-less EIN application, IRS Form 5472/1120 filing, FinCEN BOI report, and Mercury bank account setup managed by certified US tax advisors." }),
