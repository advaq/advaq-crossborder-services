...
const categories = ["All", "UK Blog", "USA Blog", "UAE Blog", "Pakistan Blog", "Legal Contracts"];
function BlogIndexPage() {
  ...
  const filteredArticles = articles.filter((art) => {
    const matchesCategory = selectedCategory === "All" || art.category === selectedCategory || selectedCategory === "UK Blog" && (art.category === "UK Blog" || art.category === "UK Business Setup" || art.category === "UK Setup") || selectedCategory === "USA Blog" && (art.category === "USA Blog" || art.category === "USA Setup" || art.category === "US Setup") || selectedCategory === "UAE Blog" && (art.category === "UAE Blog" || art.category === "UAE Setup" || art.category === "UAE Freezone") || selectedCategory === "Pakistan Blog" && (art.category === "Pakistan Blog" || art.category === "Pakistan Setup" || art.category === "Pakistan SECP & FBR") || selectedCategory === "Legal Contracts" && (art.category === "Legal Contracts" || art.category === "Legal Contract Drafting");
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white", children: [
    /* @__PURE__ */ jsxs("section", { className: "bg-navy-950 pt-36 pb-20 text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative max-w-5xl mx-auto px-6 text-center", children: /* @__PURE__ */ jsxs(Reveal, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-8 max-w-xl mx-auto relative", children: [
          /* @__PURE__ */ jsx("input", { type: "text", placeholder: "Search articles (e.g. UK company non resident, IRS 5472, UAE tax)...", value: searchQuery, onChange: (e) => handleSearchChange(e.target.value), className: "w-full bg-navy-900/90 border border-white/20 rounded-full px-6 py-4 pl-12 text-sm text-white placeholder-navy-300 focus:outline-none focus:border-gold-500 transition-all shadow-xl" }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "max-w-6xl mx-auto px-6 py-20", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4 mb-12 border-b border-border pb-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: categories.map((cat) => /* @__PURE__ */ jsx("button", { onClick: () => handleCategoryChange(cat), className: `px-4 py-2 rounded-full text-xs font-semibold transition-all ${selectedCategory === cat ? "bg-navy-950 text-gold-500 shadow-md" : "bg-off-white text-gray-600 hover:bg-gray-200"}`, children: cat }, cat)) })
      ] }),
      filteredArticles.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-16 bg-off-white rounded-2xl border border-border", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-8", children: paginatedArticles.map((art) => /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", { className: "border border-border rounded-xl p-6 bg-white hover:shadow-xl hover:border-gold-500/40 transition-all flex flex-col justify-between h-full group", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-xs text-gray-500 mb-3", children: [
              /* @__PURE__ */ jsx("span", { className: "font-semibold uppercase tracking-wider text-gold-600", children: art.category === "UK Business Setup" || art.category === "UK Setup" ? "UK BLOG" : art.category === "USA Setup" || art.category === "US Setup" ? "USA BLOG" : art.category === "UAE Freezone" || art.category === "UAE Setup" ? "UAE BLOG" : art.category === "Pakistan SECP & FBR" || art.category === "Pakistan Setup" ? "PAKISTAN BLOG" : art.category }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-6 pt-4 border-t border-border/60 flex items-center justify-between gap-3", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[11px] font-medium text-gray-400", children: art.date }),
            /* @__PURE__ */ jsxs(Link, { to: art.slug, className: "px-4 py-2 rounded-xl bg-navy-950 hover:bg-gold-500 text-white hover:text-navy-950 font-bold text-[11px] uppercase tracking-wider inline-flex items-center gap-1.5 transition-all shadow-sm hover:scale-[1.02]", children: [
              /* @__PURE__ */ jsx("span", { children: "READ GUIDE" }),
              /* @__PURE__ */ jsx(ArrowRight, { size: 12, className: "shrink-0" })
            ] })
          ] })
        ] }) }, art.slug)) }),
        totalPages > 1 && /* @__PURE__ */ jsxs("div", { className: "mt-14 flex items-center justify-center gap-2", children: [
          /* @__PURE__ */ jsx("button", { onClick: () => {
          ...
          }, disabled: currentPage === 1, className: "px-4 py-2.5 rounded-xl border border-navy-900/20 text-navy-950 font-bold text-xs uppercase tracking-wider disabled:opacity-30 disabled:cursor-not-allowed hover:bg-navy-950 hover:text-white transition-all", children: "← Previous" }),
          Array.from({
            length: totalPages
          }, (_, i) => i + 1).map((pageNum) => /* @__PURE__ */ jsx("button", { onClick: () => {
            setCurrentPage(pageNum);
            window.scrollTo({
              top: 400,
              behavior: "smooth"
            });
          }, className: `w-10 h-10 rounded-xl font-bold text-xs transition-all ${currentPage === pageNum ? "bg-navy-950 text-gold-500 shadow-md scale-105" : "bg-off-white text-gray-700 hover:bg-gray-200"}`, children: pageNum }, pageNum)),
          /* @__PURE__ */ jsx("button", { onClick: () => {
          ...
          }, disabled: currentPage === totalPages, className: "px-4 py-2.5 rounded-xl border border-navy-900/20 text-navy-950 font-bold text-xs uppercase tracking-wider disabled:opacity-30 disabled:cursor-not-allowed hover:bg-navy-950 hover:text-white transition-all", children: "Next →" })
        ] })
      ] })
    ] }),
