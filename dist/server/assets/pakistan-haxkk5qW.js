...
function PakistanCalculatorsHubPage() {
  ...
  const keyRates = [{
    label: "IT Export Tax Rate",
    value: "0.25%",
    detail: "Section 154A Reduced Rate"
  }, {
    label: "Property Buyer WHT",
    value: "3% vs 10.5%",
    detail: "ATL Filer vs Non-Filer"
  }, {
    label: "Services WHT Rate",
    value: "9% vs 18%",
    detail: "Section 153 Filer / Non-Filer"
  }, {
    label: "FBR Compliance",
    value: "2026/2027",
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white text-navy-950", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "bg-navy-950 pt-36 pb-20 text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-5xl mx-auto px-6 text-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 text-xs uppercase tracking-widest text-gold-400 font-semibold mb-4", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-gray-300", children: "Pakistan Calculators" })
        ] }),
        /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-gold-500/10 text-gold-400 border border-gold-500/20 mb-6", children: [
          ...
          " FBR & SECP 2026/2027 Tax Rules & Rates Updated"
        ] }),
        /* @__PURE__ */ jsx("h1", { className: "font-serif text-3xl sm:text-4xl md:text-5xl text-white font-medium max-w-4xl mx-auto leading-tight", children: "🇵🇰 Pakistan SECP & FBR Tax Calculators Suite (2026)" }),
        /* @__PURE__ */ jsxs("p", { className: "mt-5 text-navy-200 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed space-y-1", children: [
          /* @__PURE__ */ jsx("span", { className: "block", children: "15 free interactive tax, compliance, and financial estimators for Active Taxpayers (ATL Filers), IT exporters, property buyers, and SECP companies." }),
          /* @__PURE__ */ jsx("span", { className: "block text-gold-400/90 text-xs sm:text-sm font-medium pt-1", children: "Updated for FBR Iris 2026/2027 budget rules, provincial sales tax (PRA/SRB/KPRA), and SECP statutory compliance deadlines." })
        ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-slate-50 border-t border-border py-16", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "font-serif text-2xl sm:text-3xl font-bold text-navy-950 mt-2", children: "Frequently Asked Questions (Pakistan SECP & FBR Tax)" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 mt-2 max-w-xl mx-auto", children: "Quick authoritative guidance on FBR ATL status, Section 154A IT export tax, Section 153 WHT, and SECP company registration." })
      ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-navy-950 text-white py-16 border-t border-navy-900", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-6 text-center space-y-6", children: [
      /* @__PURE__ */ jsx("h2", { className: "font-serif text-2xl sm:text-3xl font-bold", children: "Need Personal Guidance from a Pakistan FBR Tax & SECP Specialist?" }),
      /* @__PURE__ */ jsx("p", { className: "text-navy-200 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed", children: "Get your FBR Iris tax filings, ATL status activation, SECP Form A/29 annual compliance, and IT export tax exemptions handled directly by licensed advocates and chartered tax advisors." }),
