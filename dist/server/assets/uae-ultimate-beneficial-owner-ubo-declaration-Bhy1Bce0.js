  ...
  return /* @__PURE__ */ jsxs("article", { className: "min-h-screen bg-white", children: [
    /* @__PURE__ */ jsxs("section", { className: "bg-navy-950 pt-36 pb-20 text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-4xl mx-auto px-6", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-6 text-navy-200 text-base sm:text-lg leading-relaxed max-w-3xl", children: "A practical legal transparency guide for business owners on UAE Cabinet Resolution No. 109 of 2023, registering Ultimate Beneficial Owners (UBO), maintaining shareholder registers, and penalty protection." }),
    ...
    /* @__PURE__ */ jsx("section", { className: "max-w-4xl mx-auto px-6 -mt-8 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "bg-navy-900 border border-gold-500/30 rounded-2xl p-6 md:p-8 shadow-xl text-white", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-gold-500 font-semibold text-sm uppercase tracking-wider mb-3", children: [
        ...
        /* @__PURE__ */ jsx("span", { children: "UBO Mandatory Requirements" })
      ] }),
      /* @__PURE__ */ jsxs("ul", { className: "space-y-2.5 text-sm sm:text-[15px] text-navy-100 leading-relaxed", children: [
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "UBO Threshold:" }),
        ...
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "3 Mandatory Registers:" }),
        ...
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "15-Day Update Mandate:" }),
        ...
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gold-500 font-bold", children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Penalties:" }),
            " Administrative fines start at AED 20,000 to AED 100,000 plus trade license suspension."
          ] })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("section", { className: "max-w-4xl mx-auto px-6 py-16 text-gray-800 leading-relaxed text-[16px]", children: [
      /* @__PURE__ */ jsxs("div", { className: "bg-off-white border border-border p-6 rounded-xl mb-12", children: [
        ...
        /* @__PURE__ */ jsxs("ol", { className: "space-y-2 text-sm text-navy-900 list-decimal list-inside font-medium", children: [
          ...
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "#three-registers", className: "hover:text-gold-600 underline", children: "3. The 3 Mandatory Corporate Registers Every Company Must Keep" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "#reporting-updates", className: "hover:text-gold-600 underline", children: "4. Reporting Timelines (15-Day Rule) & Licensing Portals" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "#penalties", className: "hover:text-gold-600 underline", children: "5. Avoiding Fines & License Suspensions" }) }),
      ...
      /* @__PURE__ */ jsxs("div", { id: "ubo-framework", className: "space-y-4 mb-12", children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          "To enhance international financial transparency and prevent illicit shell company usage, the UAE government enacted ",
          /* @__PURE__ */ jsx("strong", { children: "Cabinet Resolution No. 109 of 2023" }),
          "."
        ] }),
        /* @__PURE__ */ jsx("p", { children: "The resolution requires every company registered in a Freezone or Mainland jurisdiction to file accurate records of its ultimate human beneficial owners." })
      ] }),
      /* @__PURE__ */ jsxs("div", { id: "who-is-ubo", className: "space-y-4 mb-12", children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          "A ",
          /* @__PURE__ */ jsx("strong", { children: "Real Beneficial Owner" }),
          " is defined as:"
        ] }),
        /* @__PURE__ */ jsxs("ul", { className: "list-disc list-inside space-y-1.5 text-sm text-gray-700 ml-2", children: [
          /* @__PURE__ */ jsxs("li", { children: [
            "Any individual who ultimate owns or controls ",
            /* @__PURE__ */ jsx("strong", { children: "25% or more" }),
            " of company shares or voting rights."
          ] }),
          /* @__PURE__ */ jsx("li", { children: "If no individual meets the 25% threshold, any individual who exercises control through other means (e.g. appointing directors)." }),
          /* @__PURE__ */ jsx("li", { children: "If no individual is identified, the natural person holding the position of Senior Management Official (Managing Director / CEO)." })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxs("div", { id: "three-registers", className: "space-y-4 mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "font-serif text-2xl md:text-3xl text-dark-text font-semibold", children: "3. The 3 Mandatory Corporate Registers Every Company Must Keep" }),
        /* @__PURE__ */ jsx("p", { children: "Every UAE entity must maintain: (1) Register of Beneficial Owners, (2) Register of Shareholders/Partners, and (3) Register of Nominee Directors, kept at the registered office address." })
      ] }),
      /* @__PURE__ */ jsxs("div", { id: "reporting-updates", className: "space-y-4 mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "font-serif text-2xl md:text-3xl text-dark-text font-semibold", children: "4. Reporting Timelines (15-Day Rule) & Licensing Portals" }),
        /* @__PURE__ */ jsx("p", { children: "Whenever a shareholder sells shares, updates passport numbers, or changes residential addresses, the company must file an updated UBO declaration within 15 business days." })
      ] }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "bg-navy-950 py-20 text-center text-white relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-4xl mx-auto px-6", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-4 text-navy-200 text-base max-w-xl mx-auto", children: "Beneficial owner register drafting, Freezone & DET portal submissions, and 15-day detail updates." }),
