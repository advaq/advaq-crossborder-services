...
import { ArrowRight, MessageCircle, ClipboardCheck, Scale, Landmark, Globe2, BadgeCheck, ChevronRight, Laptop, Building2, ShoppingBag, Code, Users, Tag, Headphones, ListChecks, FileText, Settings, CheckCircle, Star, Calendar, Clock } from "lucide-react";
import { R as Reveal, S as SectionLabel } from "./router-DoRrh2l-.js";
import "react";
import "sonner";
function Hero() {
...
function CredibilityBar() {
  const items = [{
    ...
    Icon: ClipboardCheck,
    t: "IRS PTIN Registered",
    s: "US Tax Preparer"
  }, {
    Icon: Landmark,
    t: "SECP & FBR Registered",
    s: "Pakistan Corporate Counsel"
  }, {
    Icon: Globe2,
    t: "UK, USA, UAE & PK",
  ...
  return /* @__PURE__ */ jsx("section", { className: "bg-navy-900 border-t border-gold-500/30 border-b border-white/5 py-6", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-y-6 lg:divide-x lg:divide-white/10", children: items.map((it, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-3 px-4", children: [
