              ...
              <div className="bg-navy-950 p-8 rounded-2xl border border-white/10 relative">
                ...
                <ul className="space-y-4 text-sm text-navy-200">
                  <li className="flex items-start gap-2.5">
                    ...
                    <span>**Asset Protection:** Directors enjoy limited liability, shielding personal wealth from corporate debts.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span>**Enterprise Contracts:** Big international clients require a registered corporate entity before signing.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span>**Bank Remittances:** Commercial banks process incoming remittances without flags if sent to corporate accounts.</span>
                  </li>
                </ul>
              </div>
            </Reveal>
