              ...
              <div className="bg-navy-950 p-8 rounded-2xl border border-white/10 relative">
                ...
                <ul className="space-y-4 text-sm text-navy-200">
                  <li className="flex items-start gap-2.5">
                    ...
                    <span>**Keeps Equity Safe:** Stops a co-founder from leaving on day 2 and keeping 50% of the company forever.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span>**Investor Readiness:** Venture Capitalists will not invest unless a solid SHA is in place to manage the cap table.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span>**Privacy:** Unlike SECP documents, an SHA remains private between the founders.</span>
                  </li>
                </ul>
              </div>
            </Reveal>
