              ...
              <div className="bg-navy-950 p-8 rounded-2xl border border-white/10 relative">
                ...
                <ul className="space-y-4 text-sm text-navy-200">
                  <li className="flex items-start gap-2.5">
                    ...
                    <span>**Lower Taxes:** Halve the withholding taxes on cash withdrawals, property purchases, and vehicle registration.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span>**Visa Approvals:** Verified tax returns and wealth statements are vital for securing international travel visas.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span>**Avoid Penalties:** Avoid FBR notices, SIM blocking, and heavy statutory fines for non-compliance.</span>
                  </li>
                </ul>
              </div>
            </Reveal>
