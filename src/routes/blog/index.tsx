...
import { Search, Clock, ArrowRight, BookOpen, ShieldCheck, Tag } from "lucide-react";
...
const articles = [
  {
    ...
    excerpt:
      "Complete 2026 legal guide on how non-UK residents & foreign directors can register a UK Limited (LTD) company online from overseas without visiting the UK.",
  ...
  },
  {
    ...
    excerpt:
      "A definitive guide to passport requirements, international proof of address standards, Companies House compliance, and KYC verification for foreign directors.",
    category: "UK Business Setup",
    readTime: "8 min read",
    date: "July 21, 2026",
    featured: false,
...
export const Route = createFileRoute("/blog/")({
  head: () => ({
    meta: [
      { title: "Global Business, Tax & Legal Insights Blog | ADVAQ" },
      {
        name: "description",
        content:
          "Authoritative guides, tax rules, legal blueprints, and incorporation guides for non-residents expanding across the UK, USA, UAE, and Pakistan.",
      },
      {
        name: "keywords",
        content:
          "uk company setup guide, us llc non resident blog, uae freezone guide, pakistan secp tax blog, legal contract drafting advice",
      },
    ],
  }),
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-12 border-b border-border pb-6">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-sans font-bold text-dark-text text-lg">Filter Topics</h3>
          </div>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-semibold transition-all ${
                  selectedCategory === cat
                    ...
                    : "bg-off-white text-gray-600 hover:bg-gray-200"
                }`}
              >
                {cat}
              </button>
      ...
      <section className="bg-navy-950 py-20 text-center text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6">
          <SectionLabel center>GLOBAL ADVISORY</SectionLabel>
          <h2 className="font-serif text-3xl md:text-5xl mt-4 text-white">
            Need Expert Guidance for Your Cross-Border Business?
          </h2>
          <p className="mt-4 text-navy-200 text-base max-w-xl mx-auto">
            Book a consultation with our international advisory team to structure your business across the UK, US, UAE, and Pakistan smoothly.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link to="/contact" className="btn-gold rounded-none uppercase text-xs tracking-widest px-8 py-4 font-semibold">
