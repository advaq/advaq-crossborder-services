              ...
              <div className="bg-navy-950 p-8 rounded-2xl border border-white/10 relative">
                ...
                <ul className="space-y-4 text-sm text-navy-200">
                  <li className="flex items-start gap-2.5">
                    ...
                    <span>**Tax Efficiency:** A small salary is a deductible business expense, lowering Corporation Tax.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span>**Proof of Income:** Formal payslips are vital for mortgages, visas, and banking.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span>**Legal Extraction:** Avoid harsh tax penalties from illegal "Director's Loans."</span>
                  </li>
                </ul>
              </div>
            </Reveal>
