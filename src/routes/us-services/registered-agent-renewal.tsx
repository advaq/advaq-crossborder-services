              ...
              <div className="bg-navy-950 p-8 rounded-2xl border border-white/10 relative">
                ...
                <ul className="space-y-4 text-sm text-navy-200">
                  <li className="flex items-start gap-2.5">
                    ...
                    <span><strong className="font-semibold">Legal Reception:</strong> Accepts subpoenas and lawsuits on your behalf.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span><strong className="font-semibold">State Mail:</strong> Receives tax and compliance notices.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span><strong className="font-semibold">Privacy Shield:</strong> Keeps your personal home address off public records.</span>
                  </li>
                </ul>
              </div>
            </Reveal>
