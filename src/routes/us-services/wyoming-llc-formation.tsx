              ...
              <div className="bg-navy-950 p-8 rounded-2xl border border-white/10 relative">
                ...
                <ul className="space-y-4 text-sm text-navy-200">
                  <li className="flex items-start gap-2.5">
                    ...
                    <span>**Zero State Tax:** No state corporate income tax or franchise tax in Wyoming.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span>**Member Privacy:** Member names are not published on the state's public registry.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span>**Low Annual Costs:** Wyoming has the lowest annual state franchise fee ($60).</span>
                  </li>
                </ul>
              </div>
            </Reveal>
