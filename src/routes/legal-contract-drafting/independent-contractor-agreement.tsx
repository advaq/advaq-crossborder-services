            ...
            <Reveal>
              <div className="bg-navy-950 p-8 rounded-2xl border border-white/10 relative">
                ...
                <ul className="space-y-4 text-sm text-navy-200">
                  <li className="flex items-start gap-2.5"><CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" /><span>**IP Ownership:** Automatic transfer of copyrights and project assets.</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" /><span>**Liability Control:** Caps and limits on potential business damages.</span></li>
                  <li className="flex items-start gap-2.5"><CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" /><span>**Clear Status:** Establishes independent status avoiding employment disputes.</span></li>
                </ul>
              </div>
            </Reveal>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          <Reveal>
            <div className="bg-white border-l-4 border-l-red-600 rounded-2xl p-8 shadow-sm h-full">
              ...
              <h3 className="font-sans text-xl font-semibold text-dark-text">Loss of Intellectual Property</h3>
              <p className="text-gray-700 text-[15px] leading-[1.7] mt-3">Without an explicit IP assignment clause, freelancers may retain the copyright to the code, designs, or content they create for you.</p>
            </div>
          </Reveal>
          <Reveal>
            <div className="bg-white border-l-4 border-l-red-600 rounded-2xl p-8 shadow-sm h-full">
              <BadgeAlert className="text-red-600 mb-5" size={28} />
              <h3 className="font-sans text-xl font-semibold text-dark-text">Scope Creep & Disputes</h3>
              <p className="text-gray-700 text-[15px] leading-[1.7] mt-3">Ambiguous deliverables often lead to prolonged arguments over revisions, payments, and unmet expectations.</p>
            </div>
          </Reveal>
          <Reveal>
            <div className="bg-white border-l-4 border-l-red-600 rounded-2xl p-8 shadow-sm h-full">
              <BadgeAlert className="text-red-600 mb-5" size={28} />
              <h3 className="font-sans text-xl font-semibold text-dark-text">Misclassification Claims</h3>
              <p className="text-gray-700 text-[15px] leading-[1.7] mt-3">Tax authorities may classify your contractors as employees, leading to massive fines and back-taxes for benefits and payroll.</p>
            </div>
          </Reveal>
        </div>
      </div>
