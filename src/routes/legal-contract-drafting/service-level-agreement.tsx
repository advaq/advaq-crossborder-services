              ...
              <div className="bg-navy-950 p-8 rounded-2xl border border-white/10 relative">
                ...
                <ul className="space-y-4 text-sm text-navy-200">
                  <li className="flex items-start gap-2.5">
                    ...
                    <span><strong className="font-semibold">Boundary Setting:</strong> Stop midnight WhatsApp messages from clients.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span><strong className="font-semibold">Recurring Income:</strong> Justify monthly maintenance retainers legally.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle size={16} className="text-gold-500 mt-0.5 shrink-0" />
                    <span><strong className="font-semibold">Liability Capping:</strong> Limit penalties if a server crashes unexpectedly.</span>
                  </li>
                </ul>
              </div>
            </Reveal>
