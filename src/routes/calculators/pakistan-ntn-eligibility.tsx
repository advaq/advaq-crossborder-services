...
export const Route = createFileRoute("/calculators/pakistan-ntn-eligibility")({
  head: () => ({
    meta: [
      { title: "NTN Registration Eligibility & Document Checker (2026) | ADVAQ" },
      {
        name: "description",
        content:
      ...
      },
      {
        name: "keywords",
        content:
          "fbr ntn registration checker pakistan 2026, how to get ntn number salaried business individual, secp company ntn registration documents checklist",
      },
      {
        property: "og:title",
      ...
      { property: "og:url", content: "/calculators/pakistan-ntn-eligibility" },
    ],
    links: [{ rel: "canonical", href: "https://advaq.com/calculators/pakistan-ntn-eligibility" }],
  }),
...
function PakistanNTNEligibilityPage() {
  ...
  // Document requirements & processing details
  const details: Record<string, { docs: string[]; timeline: string; fee: string }> = {
    ...
    company: {
      docs: [
        ...
        "Form A & Form 29 / Incorporation Form",
      ...
      <section className="bg-navy-950 pt-36 pb-20 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl text-white font-medium max-w-3xl mx-auto leading-tight">
            FBR NTN Registration & Document Checker (2026)
          </h1>
